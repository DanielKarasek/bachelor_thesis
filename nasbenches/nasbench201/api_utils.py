...
class NASBenchMetaAPI(metaclass=abc.ABCMeta):
  ...
  def query_index_by_arch(self, arch):
    ...
    """
    logging.info('Call query_index_by_arch with arch={:}'.format(arch))
...
class ArchResults(object):
  ...
  def get_metrics(self, dataset, setname, iepoch=None, is_random=False):
    """
      This `get_metrics` function is used to obtain the loss, accuracy, etc information on a specific dataset.
